  ...
  <div class="portfolio">
    ...
    <main>
      ...
      <section id="about" class="section">
        <h2>About Me</h2>
        <p>I'm a passionate developer who loves building beautiful and functional web applications. </p>
      </section>
    ...
    <footer class="footer">
      <p>&copy; 2025 Your Name. Built with Nuxt.js</p>
    </footer>
  </div>
</template>
